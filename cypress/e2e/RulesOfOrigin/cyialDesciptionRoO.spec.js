...
*/
// NOT REQUIRED AS PART OF ROO TAB CHANGES - https://transformuk.atlassian.net/browse/HOTT-1900
describe.skip('| specialDescriptionRoO - Rules with special descriptions ', {tags: ['config', 'roo-tag']}, function() {
  const service = [''];
