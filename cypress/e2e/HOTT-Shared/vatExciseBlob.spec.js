...
describe('| vatExciseBlob.spec | VAT and Excise blob on UK |', function() {
  it(`Multiple excise rates, single VAT rate`, function() {
  ...
  it(`Multiple VAT rates - 2, but no excise`, function() {
    cy.visit(`/commodities/6101201000`);
    cy.get('h3#vat_excise').contains('Import VAT and excise');
  ...
  //
  it(`Multiple VAT rates - 3, but no excise`, function() {
    cy.visit(`/commodities/8716109800`);
    cy.get('h3#vat_excise').contains('Import VAT and excise');
