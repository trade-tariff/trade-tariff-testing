...
describe('| RoW-GB301-onlyLPA-e2e.spec | AlcoholDuties X301|', function() {
  it(' RoW 🇸🇬 Antigua and Barbuda - 🇬🇧 GB - Alcohol duties calculations ', function() {
      cy.visit('/duty-calculator/uk/2208701000/import-date');
      cy.validFutureDate(); //new
      cy.selectDestination('gb');
      cy.originList({value: 'Antigua and Barbuda'});
      //cy.selectOriginNew('Antigua and Barbuda');//new
          cy.customsValue({monetary: '500.00', shipping: '250.00', cost: '250.00'});
      cy.alcoholImportQuantity({lpa: '100', asv: '1.1', spr: '3'}); //commented out text verifications 206 and 207
      cy.exciseCode('301');
