...
describe('| importGuidanceLinkSTW.spec | STW content on commodity import page |', function() {
  it('| UK Service - STW content on Commodity import page |', function() {
    ...
    cy.contains('Now you have identified your commodity code, you can check how to import commodity 2612201000 from Andorra.');
    ...
    cy.contains('Now you have identified your commodity code, you can check how to import commodity 2612201000 from India.');
