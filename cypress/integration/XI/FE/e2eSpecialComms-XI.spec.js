describe('🇪🇺 💡 | e2eSpecialComms-XI.spec | XI - Select Commodities and measure details |',function() {
    ...
    it(' 🍅 Cherry Tomatoes \n Check that there is no directly assigned third country duty\n' +
     ...
     //       cy.contains('Greater than or equal to  EUR / 100 kg Apply the amount of the action 8.80 %')
     //       cy.contains('Greater than or equal to  EUR / 100 kg Apply the amount of the action 8.80 % + 1.70 EUR / 100 kg')
