describe('Old UK 🇬🇧  💡 Terms & Conditions, Cookies ,Privacy links ,Previous/Next Commodity Links ',function() {
//  HOTT-192
    Cypress.config('baseUrl')


    it('OUK - Terms and Conditions -navigates to right UK page',function(){
        cy.visit('/sections')
    ...
    it('OUK- Terms and Conditions - New UK Content',function(){
    ...
    it('OUK - Cookies - navigates to right UK page',function(){
        cy.visit('/sections')
    ...
    it('OUK - Privacy -navigates to right UK page',function(){
        cy.visit('/sections')
    ...
    //HOTT-166
    it('OUK - List of supplementary units and their descriptions in imports to be HIDDEN',function(){
    ...
    it('OUK - List of supplementary units and their descriptions in exports to be HIDDEN',function(){
