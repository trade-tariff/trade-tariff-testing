//validate legal acts 
describe('| legal-acts.spec.js |  | legal acts API checks  |', function () {
    it('UK - V2 API check  ', function () {
        ...
        //    console.log(JSON.stringify(response.body))
            ...
            expect(response.body.included[280].attributes).to.have.property('regulation_url')
                .contains('https://www.legislation.gov.uk/uksi/2019/16')
            console.log(response.body.included[280])
            expect(response.body.included[280]).to.have.property('id')
                .contains('A1900160')
        })
    })
