...
Δ MFN = £7.00
*/
describe('| Row-NI304.spec.js | Δ MFN < 3% of Import duties = UK import duties apply + measure units | ', function () {

    Cypress.config('baseUrl', Cypress.config('services')['dutycal'])
    let country = ["uk", "xi"]
    for (let i = 0; i < country.length; i++) {
        it.only(`RoW 🇳🇵(India) to NI ${country[i]} service`, function () {
            cy.visit(`${country[i]}/1509102090/import-date`)
