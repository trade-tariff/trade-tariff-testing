describe('| dcAdditionalCode | RoW to GB - additional codes |',function(){
 ...
 it(`additional code 🇮🇱`,function(){
    ...
    cy.contains('To trade this commodity, you need to specify an additional 4 digits, known as an additional code. This affects the third country duty.')
