describe('🚀 OUK 🇬🇧 💡 - Smoke Test to cover basic functionality on UK services ',function() {
    ...
    it('🚀 OUK - United Kingdom should not be shown in EU country list', function () {
    ...
    it('🚀 OUK Switching link banner on sections page for Jan 1 2021',function(){
    ...
    it('🚀 OUK quota numbers without defining date  -052xxx Non-Licensed', function () {
    ...
    it('🚀 OUK quota numbers post 1 Jan 2021 -054xxx Licensed', function () {
    ...
    it('🚀 OUK quota numbers post 1 Jan 2021 -052xxx Non-Licensed', function () {
        cy.visit('/commodities/0201100021?day=2&month=1&year=2021#import')
        cy.get('.govuk-tabs__panel')
        cy.contains('Non preferential tariff quota')
        cy.get('.table-line')
