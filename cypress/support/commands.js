...
Cypress.Commands.add('validDate', ()=>{
  cy.contains('When will the goods be imported?');
  cy.title().should('matches', 'When will the good be imported - Online Tariff Duty calculator');
...
Cypress.Commands.add('selectDestination', (destination)=>{
  ...
  cy.title().should('matches', 'Which part of the UK are you importing into - Online Tariff Duty calculator');
  if (destination === 'xi') {
...
Cypress.Commands.add('selectOrigin', (origin)=>{
  ...
  cy.title().should('matches', 'Which country are the goods dispatched from - Online Tariff Duty calculator');
  if (origin === 'gb') {
...
Cypress.Commands.add('dutiesApply', ()=>{
  ...
  cy.title().should('matches', 'Duties apply to this import - Online Tariff Duty calculator');
  cy.wait(100);
  cy.get('.govuk-button').click();
});
Cypress.Commands.add('euDutiesApply', () => {
  cy.contains('EU duties apply to this import');
  cy.title().should('matches', 'EU duties apply to this import - Online Tariff Duty calculator');
  cy.wait(100);
  cy.get('.govuk-button').click();
});
...
Cypress.Commands.add('traderScheme', (selection)=>{
  ...
  cy.title().should('matches', 'Are you authorised under the UK Trader Scheme - Online Tariff Duty calculator');
  if (selection === 'yes') {
...
Cypress.Commands.add('certificate', (selection)=>{
  ...
  cy.title().should('matches', 'Do you have a valid proof of origin - Online Tariff Duty calculator');
  if (selection === 'yes') {
...
Cypress.Commands.add('customsValue', (monvalue)=>{
  ...
  cy.title().should('matches', 'What is the customs value of this import - Online Tariff Duty calculator');
...
Cypress.Commands.add('quantity', (measureUnits)=>{
  ...
  cy.title().should('matches', 'Enter import quantity - Online Tariff Duty calculator');
...
Cypress.Commands.add('finalUse', (value)=>{
  cy.title().should('matches', 'Are your goods for final use in the UK - Online Tariff Duty calculator');
...
Cypress.Commands.add('confirmPage', ()=>{
  ...
  cy.title().should('matches', 'Check your answers - Online Tariff Duty calculator');
  cy.get('.govuk-button').click();
  cy.wait(200);
});
...
Cypress.Commands.add('dutyPage', ()=>{
  ...
  cy.title().should('matches', 'Import duty calculation - Online Tariff Duty calculator');
});
Cypress.Commands.add('noDuty', (options)=>{
  cy.contains('There is no import duty to pay');
  cy.title().should('matches', 'There is no import duty to pay - Online Tariff Duty calculator');
});
...
Cypress.Commands.add('additionalCode', (addcode)=>{
  ...
  cy.title().should('matches', 'Describe your goods in more detail - Online Tariff Duty Calculator');
...
Cypress.Commands.add('plannedXI', (options)=>{
  ...
  cy.title().should('matches', 'How will your goods be processed - Online Tariff Duty calculator');
...
Cypress.Commands.add('vat', (options)=>{
  ...
  cy.title().should('matches', 'Which VAT rate is applicable to your trade - Online Tariff Duty Calculator');
  if (options === '5') {
...
Cypress.Commands.add('exciseCode', (excode) => {
  ...
  cy.title().should('matches', 'Which class of excise is applicable to your trade - Online Tariff Duty Calculator');
...
Cypress.Commands.add('docCode', (dcode)=>{
  ...
  cy.title().should('matches', 'Do you have any of the following documents - Online Tariff Duty Calculator');
